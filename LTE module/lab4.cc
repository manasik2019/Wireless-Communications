...
int main (int argc, char *argv[])
{
  ...
  lteHelper->SetEnbAntennaModelType ("ns3::ParabolicAntennaModel"); // parabolic, cosine and isotropic
  ...
  MM -> SetPosition(Vector3D(-500,0,1)); // distance between UE and eNodeB is 5 metres
...
// Install and start applications on UE and remote host
 uint16_t dlPort = 1000;
  ...
  ApplicationContainer onOffApp;
    ...
    onOffHelper.SetAttribute("DataRate", DataRateValue(DataRate("50.0Mbps"))); //try with 50, 100, 150
//Traffic Bit Rate

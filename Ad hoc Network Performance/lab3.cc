...
/////////////////////////////Application part///////////////////////////// 
  ...
  //   onOffHelper.SetAttribute("PacketSize", UintegerValue(1436)); // Packet size
...
///////////////USE WHEN WORKING WITH TCP TO FILL IN ARP TABLES//////////////////////
  ...
  echoClient.SetAttribute ("PacketSize", UintegerValue (300));
...
/////////////////////TCP app///////////////////////////
  ...
  // uint16_t port = 50000;
  // Address sinkLocalAddress (InetSocketAddress (Ipv4Address::GetAny (), port)); //was Ipv4Address::GetANy()
...
/////////////////////////////PCAP tracing/////////////////////////////   
   ...
   phy.EnablePcap ("300B_WIFI_Lab3", wifiStaNodes, true); 
